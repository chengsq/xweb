...
seopress_option::add_field( 'my_config', array(
	...
	'section'     => 'seopress_theme_info',
	'default'     => '<div style="background-color: #333;border-radius: 9px;color: #fff;padding: 13px 7px;">Do you want to visit demo pages? Please <a target="_blank" href="http://seopress.rinkuyadav.com/">Click for visit demo</a>.</div>',
	'priority'    => 10,
) );

seopress_option::add_field( 'my_config', array(
	'type'        => 'custom',
	'settings'    => 'seopress_custom_dnt',
	'label'       => __( 'Donate to Theme Developer', 'seopress' ),
	'section'     => 'seopress_theme_info',
	'default'     => '<div style="background-color: #333;border-radius: 9px;color: #fff;padding: 13px 7px;">Please donate to theme developer, so he can keep SEOPress theme updated with advance features. <a target="_blank" href="https://www.paypal.me/RinkuYadav">Donate Now</a>.</div>',
	'priority'    => 10,
) );
...
seopress_option::add_field( 'my_config', array(
	...
	'section'     => 'seopress_theme_info',
	'default'     => '<div style="background-color: #333;border-radius: 9px;color: #fff;padding: 13px 7px;">Do you want premium plugins? Please <a target="_blank" href="https://rinkuyadav.com/product/seopress-pro-wordpress-theme/">Install SEOPress Pro version</a>.</div>',
	'priority'    => 10,
) );
