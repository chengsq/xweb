...
<div class="container-fluid footer pdt10 pdb5 clearfix">
	<div class="container">
		...
		if( class_exists( 'RWMB_Loader' ) )
		{
			...
			{
				$seopress_number_of_footer_widgets = get_theme_mod( 'seopress_number_of_footer_widgets', '0' );
		...
		<div class="row mrt10">
			...
			<div class="col-md-4 alignr-spsl">
				...
				<p><?php _e( 'WordPress', 'seopress' ); ?> <a href="<?php $seopress_credit_link = 'http://rinkuyadav.com/product/seopress-pro-wordpress-theme/'; echo esc_url( $seopress_credit_link ); ?>"><span class="fa fa-thumbs-o-up"></span> <?php _e( 'SEOPress Pro', 'seopress' ); ?></a> <?php _e( 'Theme', 'seopress' ); ?></p>
