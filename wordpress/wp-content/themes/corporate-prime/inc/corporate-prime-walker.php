 ...
 */
 	/** nav-menu-walker	*/
class corporate_prime_nav_walker extends Walker_Nav_Menu {
...
function corporate_prime_nav_menu_css_class( $classes ) {
...
add_filter( 'nav_menu_css_class', 'corporate_prime_nav_menu_css_class' );
